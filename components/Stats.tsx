                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="px-5 py-2.5 bg-brand-secondary rounded-full text-brand-accent border border-brand-border text-sm font-medium hover:bg-brand-accent hover:text-white transition-colors">Technology</span>
                                <span className="px-5 py-2.5 bg-brand-secondary rounded-full text-brand-black border border-brand-border text-sm font-medium hover:bg-brand-black hover:text-white transition-colors">Web hosting</span>
                                <span className="px-5 py-2.5 bg-brand-secondary rounded-full text-gray-600 border border-brand-border text-sm font-medium">Online business</span>
                                <span className="px-5 py-2.5 bg-brand-secondary rounded-full text-gray-500 border border-brand-border text-sm font-medium">Automation</span>
                                <span className="px-5 py-2.5 bg-brand-secondary rounded-full text-gray-800 border border-brand-border text-sm font-medium">Crypto & trading</span>
                            </div>
                            <div className="pt-10">
